...
Simple, distraction-free markdown note-taking
...
- **flatnotes**: flatnotes/flatnotes:latest

## 📦 Installation

### Option 1: Quick Install
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/flatnotes/main/docker-compose.yaml" -o compose.yml
```
